...
import com.cn.wubin.service.impl.BannerInfoServiceImpl;
...
//                Class clazz = BannerInfoServiceImpl.class;
//                Object object = null;
//                try {
//                    Method method = clazz.getMethod("queryBannerInfo",Long.class);
//                    object = method.invoke(clazz.newInstance(),l);
//                } catch (Exception e) {
//                    e.printStackTrace();
//                }
